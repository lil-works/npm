 ...
 */
class Interfero extends \AppBundle\Entity\Interfero implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Interfero' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Interfero' . "\0" . 'antenna', '' . "\0" . 'AppBundle\\Entity\\Interfero' . "\0" . 'band', '' . "\0" . 'AppBundle\\Entity\\Interfero' . "\0" . 'available', 'breakdowns_interferos'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Interfero $proxy) {
