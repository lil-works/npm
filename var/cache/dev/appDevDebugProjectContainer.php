...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/operator');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/analyzer');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/manager');
        ...
        $r->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/profile', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSonata_Seo_Page_DefaultService()
    {
        ...
        $instance->setMetas(array('name' => array('keywords' => 'harmony,scale,chord,visualization,guitar,bass,ukulele,violin', 'description' => 'Designed to track breakdown', 'robots' => 'index, follow'), 'property' => array('og:site_name' => 'iram', 'og:description' => 'Noema pareto manager'), 'http-equiv' => array('Content-Type' => 'text/html; charset=utf-8'), 'charset' => array('UTF-8' => '')));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'AppBundle', 1 => 'ManagerBundle', 2 => 'AnalyzerBundle', 3 => 'OperatorBundle', 4 => 'SiteBundle', 5 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
