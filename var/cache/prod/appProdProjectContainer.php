...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.type.breakdown' => 'getApp_Form_Type_BreakdownService',
            'app.form.type.person' => 'getApp_Form_Type_PersonService',
            'app.hello_controller' => 'getApp_HelloControllerService',
        ...
        $this->aliases = array(
            ...
            'fr3d_ldap.user_hydrator' => 'ldap.user_hydrator',
    ...
    /*
     * Gets the 'app.form.type.breakdown' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\BreakdownType A AppBundle\Form\BreakdownType instance.
     */
    protected function getApp_Form_Type_BreakdownService()
    {
        return $this->services['app.form.type.breakdown'] = new \AppBundle\Form\BreakdownType($this->get('doctrine', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }

    /*
     * Gets the 'app.form.type.person' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_Form_Type_PersonService()
    {
        return $this->services['app.form.type.person'] = new \AppBundle\Form\PersonType($this->get('doctrine', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }

    /*
     * Gets the 'app.hello_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\HelloController A AppBundle\Controller\HelloController instance.
     */
    protected function getApp_HelloControllerService()
    {
        return $this->services['app.hello_controller'] = new \AppBundle\Controller\HelloController($this->get('templating'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'npm', 'user' => 'npm', 'password' => '8Hdc4hu6V9bp9Y78', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addCustomStringFunction('SPLIT_STRING', 'ManagerBundle\\DQL\\SplitStringFunction');
        $d->addCustomStringFunction('REPLACE_PIPE', 'ManagerBundle\\DQL\\ReplacePipeFunction');
        $d->addCustomStringFunction('GREATEST', 'ManagerBundle\\DQL\\GreatestFunction');
        $d->addCustomStringFunction('LEAST', 'ManagerBundle\\DQL\\LeastFunction');
        $d->addCustomStringFunction('REPLACE', 'ManagerBundle\\DQL\\ReplaceFunction');
        $d->addCustomStringFunction('GROUP_CONCAT', 'ManagerBundle\\DQL\\GroupConcatFunction');
        $d->addCustomStringFunction('IF', 'ManagerBundle\\DQL\\IfFunction');
        $d->addCustomDatetimeFunction('DATE_FORMAT', 'ManagerBundle\\DQL\\DateFormatFunction');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_584ffc57890a543024967aedad8b8befb719525eb2eeb7965eb04a343981efb8');
    ...
    {
        return $this->services['fr3d_ldap.ldap_driver.zend'] = new \FR3D\LdapBundle\Driver\ZendLdapDriver(new \Zend\Ldap\Ldap(array('host' => 'netsrv1.iram.fr', 'bindRequiresDn' => true, 'useSsl' => true, 'port' => 389, 'useStartTls' => false, 'baseDn' => 'OU=People,DC=iram,DC=fr', 'accountFilterFormat' => '(&(ObjectClass=Person))')), $this->get('monolog.logger.ldap_driver'));
    }
    ...
    {
        return $this->services['fr3d_ldap.ldap_manager.default'] = new \FR3D\LdapBundle\Ldap\LdapManager($this->get('fr3d_ldap.ldap_driver.zend'), $this->get('ldap.user_hydrator'), array('baseDn' => 'OU=People,DC=iram,DC=fr', 'filter' => '(&(ObjectClass=Person))', 'attributes' => array(0 => array('ldap_attr' => 'uid', 'user_method' => 'setUsername')), 'usernameAttribute' => 'uid'));
    }
    ...
    {
        return $this->services['fr3d_ldap.user_hydrator.default'] = new \FR3D\LdapBundle\Hydrator\LegacyHydrator($this->get('fos_user.user_manager'), array('baseDn' => 'OU=People,DC=iram,DC=fr', 'filter' => '(&(ObjectClass=Person))', 'attributes' => array(0 => array('ldap_attr' => 'uid', 'user_method' => 'setUsername')), 'usernameAttribute' => 'uid'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AcmeBundle\\Acme\\User\\LdapUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/profile', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'LexikFormFilterBundle:Form:form_div_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'AppBundle', 1 => 'ManagerBundle', 2 => 'AnalyzerBundle', 3 => 'OperatorBundle', 4 => 'SiteBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
