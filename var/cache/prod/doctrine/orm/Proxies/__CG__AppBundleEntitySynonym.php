 ...
 */
class Synonym extends \AppBundle\Entity\Synonym implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Synonym' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Synonym' . "\0" . 'label', '' . "\0" . 'AppBundle\\Entity\\Synonym' . "\0" . 'descriptor'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Synonym $proxy) {
