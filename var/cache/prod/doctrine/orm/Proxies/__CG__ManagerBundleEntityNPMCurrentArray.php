 ...
 */
class NPMCurrentArray extends \ManagerBundle\Entity\NPMCurrentArray implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ManagerBundle\\Entity\\NPMCurrentArray' . "\0" . 'id', '' . "\0" . 'ManagerBundle\\Entity\\NPMCurrentArray' . "\0" . 'antenna', '' . "\0" . 'ManagerBundle\\Entity\\NPMCurrentArray' . "\0" . 'band', '' . "\0" . 'ManagerBundle\\Entity\\NPMCurrentArray' . "\0" . 'available', 'events_currentArrays'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMCurrentArray $proxy) {
    ...
    public function setAntenna($antenna)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAntenna', [$antenna]);

        return parent::setAntenna($antenna);
    }
    ...
    public function getAntenna()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAntenna', []);

        return parent::getAntenna();
    }
