 ...
 */
class Gift extends \AppBundle\Entity\Gift implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gift' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Gift' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Gift' . "\0" . 'persons'];
        }
