 ...
 */
class NPMEventsElements extends \ManagerBundle\Entity\NPMEventsElements implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'event', 'element'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMEventsElements $proxy) {
