 ...
 */
class NPMEventsActions extends \ManagerBundle\Entity\NPMEventsActions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'event', 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMEventsActions $proxy) {
