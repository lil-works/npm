 ...
 */
class NPMSynonym extends \ManagerBundle\Entity\NPMSynonym implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'id', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'label', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'element', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'state', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'contributor', '' . "\0" . 'ManagerBundle\\Entity\\NPMSynonym' . "\0" . 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMSynonym $proxy) {
