 ...
 */
class PersonsMilestones extends \AppBundle\Entity\PersonsMilestones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'person', 'milestone', 'archived'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PersonsMilestones $proxy) {
    ...
    public function setMilestone(\AppBundle\Entity\Milestone $milestone)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMilestone', [$milestone]);

        return parent::setMilestone($milestone);
    }
    ...
    public function getMilestone()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMilestone', []);

        return parent::getMilestone();
    }
