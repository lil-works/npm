 ...
 */
class NPMContributor extends \ManagerBundle\Entity\NPMContributor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ManagerBundle\\Entity\\NPMContributor' . "\0" . 'id', '' . "\0" . 'ManagerBundle\\Entity\\NPMContributor' . "\0" . 'label', '' . "\0" . 'ManagerBundle\\Entity\\NPMContributor' . "\0" . 'events_contributors', '' . "\0" . 'ManagerBundle\\Entity\\NPMContributor' . "\0" . 'synonyms'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMContributor $proxy) {
    ...
    public function formatLabel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'formatLabel', []);

        return parent::formatLabel();
    }
