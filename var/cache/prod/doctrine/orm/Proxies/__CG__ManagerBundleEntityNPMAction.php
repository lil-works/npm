 ...
 */
class NPMAction extends \ManagerBundle\Entity\NPMAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ManagerBundle\\Entity\\NPMAction' . "\0" . 'id', '' . "\0" . 'ManagerBundle\\Entity\\NPMAction' . "\0" . 'label', '' . "\0" . 'ManagerBundle\\Entity\\NPMAction' . "\0" . 'synonyms', '' . "\0" . 'ManagerBundle\\Entity\\NPMAction' . "\0" . 'events_actions'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMAction $proxy) {
