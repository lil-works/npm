 ...
 */
class Groupy extends \AppBundle\Entity\Groupy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Groupy' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Groupy' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Groupy' . "\0" . 'persons'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Groupy $proxy) {
