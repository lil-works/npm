 ...
 */
class PersonsQualities extends \AppBundle\Entity\PersonsQualities implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'person', 'quality', 'onoff'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PersonsQualities $proxy) {
    ...
    public function setOnoff($onoff)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOnoff', [$onoff]);
    ...
    public function getOnoff()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOnoff', []);
