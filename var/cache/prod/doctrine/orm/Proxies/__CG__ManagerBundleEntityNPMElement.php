 ...
 */
class NPMElement extends \ManagerBundle\Entity\NPMElement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'label', '' . "\0" . 'ManagerBundle\\Entity\\NPMElement' . "\0" . 'events_elements', '' . "\0" . 'ManagerBundle\\Entity\\NPMElement' . "\0" . 'synonyms'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMElement $proxy) {
