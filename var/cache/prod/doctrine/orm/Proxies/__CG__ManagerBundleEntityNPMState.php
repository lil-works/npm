 ...
 */
class NPMState extends \ManagerBundle\Entity\NPMState implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'label', '' . "\0" . 'ManagerBundle\\Entity\\NPMState' . "\0" . 'synonyms', '' . "\0" . 'ManagerBundle\\Entity\\NPMState' . "\0" . 'events_states'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NPMState $proxy) {
