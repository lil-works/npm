...
class InterferoType extends AbstractType
{
    /**
...
*/
        $builder
            ->add('antenna',null,array('mapped'=>true))
            ->add('band',null,array('mapped'=>true))
            ->add('id',HiddenType::class,array('mapped'=>false))
            ->add('available',OnoffType::class,array('label'=>'available'))
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\Interfero'
        ));
    }
}
